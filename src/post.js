...
render(){
    return  (<div class="card1">
                <img class="blogImage" src="https://firststoragebucketmd.s3.amazonaws.com/sportsequipment.jpg"/>
                <h2 class="blogTitle">"The Sports Industry Stepped Up Big Time In Social Response To COVID-19". PIVOT CEO, Ben Shapiro discusses how the sports community lead by example in PIVOT's First Installment of "Thought Starters". #sportspurpose #sportsbiz #PIVOTAgency </h2>
                <h5>by PIVOT Agency | Ben Shapiro | Mar 18, 2020</h5>
                <p class="greeting"></p>
                <blockquote>Hi Sports Fans, and Sports Business Fans!
